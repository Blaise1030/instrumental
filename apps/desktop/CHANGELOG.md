...
* add context queue selection popup to TerminalPane ([84c23a7](https://github.com/Blaise1030/workbench/commit/84c23a7db622dbe78b3c29ee3b5af488cf111b80))
* add context queue to local PR diff and commit textarea ([588afca](https://github.com/Blaise1030/workbench/commit/588afca1b1fe25fad3e31458ac5459fb9bb140c2))
* add context queue to remote PR diff and comments ([32ac1f3](https://github.com/Blaise1030/workbench/commit/32ac1f37cfe8bcea9420910dd66291a46103ee34))
* add remote PR review workflow to git module ([177ff52](https://github.com/Blaise1030/workbench/commit/177ff5212e1c08b489c1fb96ac0861844f71094e))
* add remote PR review workflow to git module ([c283368](https://github.com/Blaise1030/workbench/commit/c283368379cf6d7bd9e404f4858958e5033adbc3))
* add useDomSelectionQueue composable ([1d53de9](https://github.com/Blaise1030/workbench/commit/1d53de9a4ef4d2b7577dcd0a9cafb728d42b7aa3))
* add useTerminalSelectionQueue composable ([b1c549c](https://github.com/Blaise1030/workbench/commit/b1c549ce4771c7f28133239ded8fd45a3a6d4401))
* added markdown filter ([bdd1a9e](https://github.com/Blaise1030/workbench/commit/bdd1a9ea704533f88eca05c3466247f45095a2ea))
* **agent:** integrate AgentCommandsSettingsDialog and enhance ThreadAdaptivePromptInput ([6a5de1f](https://github.com/Blaise1030/workbench/commit/6a5de1f88ec189e217f0b6500bdc224fd7fccd7b))
* **branch:** enhance branch handling in layout and thread creation ([7db0a1a](https://github.com/Blaise1030/workbench/commit/7db0a1a4a7b05533dfe9efc40b063fddfa1c6fcb))
* **desktop:** add GitHub PR settings management ([10160f1](https://github.com/Blaise1030/workbench/commit/10160f19bf15808f35f3b8ed2516cb783f7e1679))
* **desktop:** add terminal session management functionality ([96e9265](https://github.com/Blaise1030/workbench/commit/96e92656b36e7da2383963a328dd590eb01335a6))
...
* **desktop:** enhance Git panel navigation and functionality ([b75688c](https://github.com/Blaise1030/workbench/commit/b75688cdb937016dc7adf9ef7b6e4ec84febd670))
* **desktop:** enhance Git pull request navigation and routing ([7a6bb7e](https://github.com/Blaise1030/workbench/commit/7a6bb7e6a67f5fb0bf39028b7e9a1c72b9a7dc18))
* **desktop:** enhance GitHub token setup and remote PR panel ([21a8343](https://github.com/Blaise1030/workbench/commit/21a83434e9e7f72d14a9c0588ec1668f3e7a200c))
* **desktop:** enhance prompt input components with adaptive features ([03083e9](https://github.com/Blaise1030/workbench/commit/03083e9f6ae3953645310ca622e898a6519c2240))
* **desktop:** implement worktree deletion functionality ([b177681](https://github.com/Blaise1030/workbench/commit/b177681284ec571eb2047eb26484640499d3f2f8))
...
* **desktop:** update sidebar width and enhance layout with fullscreen support ([874b4c4](https://github.com/Blaise1030/workbench/commit/874b4c48d4cbdbb54294a12a060a068dd95027a1))
...
* enhance global keybindings and terminal panel functionality ([1e46477](https://github.com/Blaise1030/workbench/commit/1e46477d04aedf3c4af8ee6f30c348fbfd4951eb))
...
* extract diff line numbers from DOM for compact file references ([b8c8235](https://github.com/Blaise1030/workbench/commit/b8c8235204ea9d85bd25e88c8e1a1314bc3d795c))
* **file-management:** add file rename functionality ([d510710](https://github.com/Blaise1030/workbench/commit/d51071093b47945fa32d5ac086e0329eb38111a3))
* **git:** add GitHub PR diff fetching functionality ([a8165b6](https://github.com/Blaise1030/workbench/commit/a8165b6e93fee541960dbd814add889ad81f71b5))
* **git:** extend GitService interface with SCM operations ([f69bf34](https://github.com/Blaise1030/workbench/commit/f69bf34b60741f813285b54d234c2b09452e4d23))
* **git:** implement SCM methods in IpcGitService ([42b593f](https://github.com/Blaise1030/workbench/commit/42b593f8013246d01f1313f5225490d45848c314))
* inject context to prompt input when available, navigate to agent on add-to-chat ([0b1d863](https://github.com/Blaise1030/workbench/commit/0b1d86332ef420cd5d771ad7f941c18768178bfd))
...
* integrate markdown editor with file handling and enhance project deletion confirmation ([c9db38f](https://github.com/Blaise1030/workbench/commit/c9db38f5dedb15619c12d0827c99e2f91f5a9040))
...
* **layout:** add no threads message and button in sidebar ([83943e4](https://github.com/Blaise1030/workbench/commit/83943e432a573d47e9134ebb8a537e4c0df448bf))
* **notification:** add central notification module with SQL persistence ([6e8bc88](https://github.com/Blaise1030/workbench/commit/6e8bc88ac64a5a73efa902bd3646914f6be6e2bf))
* **notification:** add central notification module with SQL persistence ([a401aa3](https://github.com/Blaise1030/workbench/commit/a401aa30740b40cefb67102d66a9cf7da2d9b862))
* **notification:** add notification module with IPC service, composable, and sidebar popover ([33defab](https://github.com/Blaise1030/workbench/commit/33defab0384a284c20f3738e6545ba0886e23c2f))
...
* pass agentTab=true to TerminalPane inside AgentPane ([72d3147](https://github.com/Blaise1030/workbench/commit/72d314720952dd95c3d3ab0f4cc1566a7dcad3be))
* provide injectContextToAgentKey and openWorkspaceFileKey in Layout ([9bbd6cb](https://github.com/Blaise1030/workbench/commit/9bbd6cb13596c2e2029f4858822aa8cd7c5ca669))
...
* **storage:** add Drizzle db factory and test helper ([533fce2](https://github.com/Blaise1030/workbench/commit/533fce27a12cd605a1d50e8f3ea2e74b8e7a8ca8))
* **storage:** add Drizzle schema definitions ([f0c0141](https://github.com/Blaise1030/workbench/commit/f0c01415aa79d534e7fdce89500ce2ab3631e272))
* **storage:** add NotificationStore with Drizzle ([8cd885e](https://github.com/Blaise1030/workbench/commit/8cd885e0b24a5c51cdf8d264a4d0f30836cef9e6))
* **storage:** add ProjectStore with Drizzle ([42cd49f](https://github.com/Blaise1030/workbench/commit/42cd49f0361af3aabf6a40c7d0aee76df7385185))
* **storage:** add RunStore with Drizzle ([3c817da](https://github.com/Blaise1030/workbench/commit/3c817da04b87a16c1f90231905db6a841b57a1c7))
* **storage:** add SettingsStore with Drizzle ([acc7779](https://github.com/Blaise1030/workbench/commit/acc7779788e9f9cde378dae7536bc9d2136fa347))
* **storage:** add ThreadStore with Drizzle ([dea86a8](https://github.com/Blaise1030/workbench/commit/dea86a81f7834f8783bf8535cc2e03b85f90488f))
* **storage:** add WorkspaceStore coordinator with Drizzle ([c36bed0](https://github.com/Blaise1030/workbench/commit/c36bed04802f0ffb73b31d8198d2e8bbda7ec1b2))
* **storage:** add WorktreeStore with Drizzle ([88824f5](https://github.com/Blaise1030/workbench/commit/88824f5a26fcb4536f21b9db14bb4616be2ff3ea))
* **storage:** wire Drizzle WorkspaceStore in mainApp, remove worktree IPC handlers ([492c252](https://github.com/Blaise1030/workbench/commit/492c252e9e686bbb7ba6d7f6125bdec03bd2cde6))
* **thread:** enhance thread management with resume ID handling and UI updates ([379ecee](https://github.com/Blaise1030/workbench/commit/379eceea2542e63d66affb33e7c67a513565c4d7))
* **toasts:** integrate toast notifications and enhance GitHub PR fetching ([db6561e](https://github.com/Blaise1030/workbench/commit/db6561e675409dbac3628caa40ddb01ea9bb75cb))
...
* **welcome:** add project selection functionality to WelcomePage ([aee400a](https://github.com/Blaise1030/workbench/commit/aee400a49d8515f1a437ab39199051f4ef0242b5))
* **workspace:** add worktree group management functionality ([22411bb](https://github.com/Blaise1030/workbench/commit/22411bb45b3fd6103ffdc0d26359367e8671a653))


### Bug Fixes

* **agent:** inject resume command via pendingBootstrap to avoid PTY race ([c207224](https://github.com/Blaise1030/workbench/commit/c207224b1b85a91cae370e661c7c071d334f061f))
* clear pendingText on dismiss and guard buildItem in useTerminalSelectionQueue ([cc3c095](https://github.com/Blaise1030/workbench/commit/cc3c095f09eb794837149ec651f096e26d49c2db))
* clear pendingText on empty selection in useDomSelectionQueue and add throw guard test ([ac4ad9c](https://github.com/Blaise1030/workbench/commit/ac4ad9c2a52409befecb5c5beefcd154e7e08ba7))
* **layout:** remove unnecessary text display in sidebar trigger ([83a2c5a](https://github.com/Blaise1030/workbench/commit/83a2c5a559fa95b13eed701c561532dd62e1854c))
...
* **sidebar:** adjust sidebar width for improved layout consistency ([2eadee3](https://github.com/Blaise1030/workbench/commit/2eadee3c4b5dc4f689af937fead987333b7c7988))
...
* **storage:** add duplicate-ID guard in ProjectStore.reorder ([5c4a247](https://github.com/Blaise1030/workbench/commit/5c4a24791857e3f79db1accd757004efc52c5bf7))
...
* wrap buildItem in try/catch and document agentTab stability in TerminalPane ([d0d4dd7](https://github.com/Blaise1030/workbench/commit/d0d4dd7c918dabd36d8e5d3c8f40ecf6045150e4))
