...
export interface SidebarProps {
  ...
  /** `nested`: absolute positioning and full parent height (for sidebars inside a panel, not the viewport). */
  layout?: 'default' | 'nested'
  /** Must match parent `SidebarProvider` `sidebarScope` (default: thread shell). */
...
export { useFileExplorerSidebar, useSidebar } from './utils'
